...
<p>Un arreglo ordenado es una secuencia de datos ordenados de menor al mayor valor.</p>
<p>El diagrama de tallo y hojas organiza los datos en grupos (llamados tallos), para que los valores dentro de cada grupo (las hojas) ramifiquen hacia la derecha de cada fila. El diagrama resultante permite ver cómo se distribuyen y dónde están las concentraciones de datos.</p>
<p>Una distribución de frecuencias es una tabla de resumen en la que los datos están organizados en clases o grupos numéricamente ordenados.</p>
