...
<p>La varianza es una medida de dispersión que representa la variabilidad de una serie de datos respecto a su media: $$\sigma^2=\frac{1}{N}\sum_{i=1}^{N} (X_i-\mu)^2$$ $$\sigma^2=\frac{1}{n-1}\sum_{i=1}^{n} (X_i-\bar{X})^2$ cuasivarianza$</p>
